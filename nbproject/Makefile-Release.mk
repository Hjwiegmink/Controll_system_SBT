...
OBJECTFILES= \
	${OBJECTDIR}/Biquad.o \
	${OBJECTDIR}/ComplementaryFilter.o \
...
${OBJECTDIR}/Biquad.o: Biquad.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Biquad.o Biquad.cpp

${OBJECTDIR}/ComplementaryFilter.o: ComplementaryFilter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ComplementaryFilter.o ComplementaryFilter.cpp

${OBJECTDIR}/DataStore.o: DataStore.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/DataStore.o DataStore.cpp

${OBJECTDIR}/Filtered_data.o: Filtered_data.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Filtered_data.o Filtered_data.cpp

${OBJECTDIR}/Force_to_wing_angle.o: Force_to_wing_angle.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
